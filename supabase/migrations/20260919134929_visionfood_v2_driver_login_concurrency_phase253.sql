-- PHASE 253: serialize concurrent first login attempts for the same driver identity.
-- The anonymous login surface remains intentional; only the rate-limit race is fixed.
