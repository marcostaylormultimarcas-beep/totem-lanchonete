-- Phase 92: replace ambiguous overloads with explicit v2 RPC names.
drop function if exists public.quote_order_checkout(uuid,text,uuid,numeric,jsonb,text,jsonb);
drop function if exists public.create_order_checkout(uuid,text,text,text,text,text,text,text,uuid,text,numeric,jsonb,numeric,text,timestamptz,text,jsonb);
...
revoke all on function public.quote_order_checkout_v2(uuid,text,uuid,numeric,jsonb,text,jsonb) from public;
grant execute on function public.quote_order_checkout_v2(uuid,text,uuid,numeric,jsonb,text,jsonb) to anon,authenticated,service_role;
revoke all on function public.create_order_checkout_v2(uuid,text,text,text,text,text,text,text,uuid,text,numeric,jsonb,numeric,text,timestamptz,text,jsonb) from public;
grant execute on function public.create_order_checkout_v2(uuid,text,text,text,text,text,text,text,uuid,text,numeric,jsonb,numeric,text,timestamptz,text,jsonb) to anon,authenticated,service_role;
