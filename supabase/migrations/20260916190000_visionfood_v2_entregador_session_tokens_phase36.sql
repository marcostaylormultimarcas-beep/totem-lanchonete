...
BEGIN
  ...
  JOIN public.entregadores e ON e.id = s.entregador_id
...
-- New login endpoint. Reuses the hardened password login and exchanges valid credentials for an opaque token.
