...
export const pdvRpc = {
  ...
  createPixIntent: (sessionToken: string, caixaId: string, items: unknown[], cupomCode: string) => rpc("pdv_create_pix_intent_v2", { _session_token: sessionToken, _caixa_id: caixaId, _items: items, _cupom_code: cupomCode }),
  pixStatus: (sessionToken: string, intentId: string) => rpc("pdv_pix_status_v2", { _session_token: sessionToken, _intent_id: intentId }),
  pixSale: (sessionToken: string, intentId: string) => rpc("pdv_registrar_venda_pix_v2", { _session_token: sessionToken, _intent_id: intentId }),
